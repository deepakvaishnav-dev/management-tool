...
export default function Register() {
  ...
  const onSubmit = async (data: RegisterForm) => {
    ...
    if (success) {
      toast({ title: 'Account created!', description: 'Welcome to ProManage. Let\'s get started!' });
      navigate('/dashboard');
    } else {
      toast({
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center gradient-primary relative overflow-hidden">
        ...
        >
          ...
          <p className="text-xl opacity-90 max-w-md">
            Join thousands of teams already using ProManage to deliver projects on time
          </p>
        </motion.div>
      </div>
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              Get started with ProManage and organize your work today
            </p>
          </div>
